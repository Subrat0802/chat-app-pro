...
const Dashboard = () => {
  ...
  return (
    <div className="w-full flex min-h-screen max-h-screen relative lg:static">
      ...
      {/* Sidebar nav */}
      {!hasConversation && <div className="flex absolute lg:static w-full bottom-0 justify-around lg:justify-start lg:items-center lg:flex-col items-center py-3 lg:pt-5 gap-3 lg:w-[4%] bg-sky-600/90 z-20">
      ...
      {/* Contacts — hidden on mobile when a conversation is open */}
      ...
      {/* Messages — full screen on mobile when conversation open */}
...
//     <div className="w-full flex min-h-screen max-h-screen relative lg:static">
//       {/* Sidebar nav */}
//       {<div className={`flex absolute lg:static w-full bottom-0 justify-around lg:justify-start lg:items-center lg:flex-col items-center py-3 lg:pt-5 gap-3 lg:bottom-0 lg:w-[4%] ${hasConversation ? "" : "bg-sky-600/90"}  z-20`}>
//         <div onClick={() => dispatch(setActiveView("message"))} className="lg:p-3 rounded-full cursor-pointer text-white/50 lg:bg-sky-400/30 h-fit">
//           <MessagesSquare />
//         </div>
//         <div onClick={() => dispatch(setActiveView("profile"))} className="lg:p-3 rounded-full text-white/50 cursor-pointer lg:bg-sky-400/30 h-fit">
